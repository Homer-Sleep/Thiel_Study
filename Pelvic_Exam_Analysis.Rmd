...
This is interesting as Question 8 deals with expectations of skills from the doctoring course to be used in the future, while question 9 address confidence of performing the pelvic exam post the doctoring course. Maybe this shows how students that retain skills from the course also have higher confidence, e.g., student engagement results in higher confidence. Questions 10 and 11 are grouped as they show higher confidence when either the thiel or task trainer are viewed as realistic. 
...
______________________________________________________________________
 - look at histograms of each before interpretation...
________________________________________________________________________

In conclusion, the majority of the variance was not in the preference or the confidence in performing a pelvic exam (only 13%). This makes sense as most students did not have previous experience and preferred the thiel embalmed training (e.g., low variance). The majority of the variance was around 

### Correlation plots

```{r, warning=FALSE, fig.height=7, fig.width=9}
# pairs.panels(Survey.dt_Num[,-1],
