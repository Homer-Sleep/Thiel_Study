...
Results = prcomp(Survey.dt.Num[-c(1,62),-1], scale = TRUE) # removed 1 and 62 as outliers
...
Note: Participants 1 and 62 were removed as outliers. 
Interpretation: 
Questions 1 (previous experience of pelvic exam on live patient), 
...
and 4 (I felt confident performing a female pelvic exam prior to participating in this Doctoring I course session.) are correlated together. This makes sense as previous experience with a live patient prepared them and gave them confidence. 
